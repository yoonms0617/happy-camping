	...
	<table class="table">
	  <tr>
	    <td class="text-center">
	    	<a href="/item_qna_list.do?ino=${ino }&page=${curpage>1?curpage-1:curpage }" class="btn btn-sm btn-primary">이전</a>
	    		${curpage } page / ${totalpage } pages
	    	<a href="/item_qna_list.do?ino=${ino }&page=${curpage<totalpage?curpage+1:curpage }" class="btn btn-sm btn-primary">다음</a>
	    </td>
	  </tr>
	</table>
</body>
