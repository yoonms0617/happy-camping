            ...
            <div id="tabs-2"> <!-- 상품 구매 안내 -->
                ...
                <ul>
                    ...
                    <p><b style="font-size: 20;color: gray">- 교환 및 반품이 가능한 경우</b><br><br>
                        ...
                        구매자의 단순변심에 의한 교환/반품에 따른 <font style="color: red">배송비(교환의 경우 왕복배송비)는 고객님께 부담</font>해주셔야 하며, 재판매가
                        가능한 상태의 제품이어야 합니다.<br><br>
                        ...
                        ※ 텐트 및 기어류는 필드에서 사용하는 제품의 특성상 필드에서의 사용후에는 불량이 발견되더라도 교환 및 환불이 불가한 경우가 있습니다. 실내에서의 제품 검수 후 사용을
                        부탁드립니다.
