...
<div class="album py-3">
    <div class="container" style="max-width: 1200px">
                ...
                <table>
                    ...
                    <c:if test="${vo.sale!=0 }">
                        ...
                        <tr> <!--   style="border-bottom: 1px solid black" -->
                            ...
                            <td class="fs-5">
                                <p><fmt:formatNumber value="${vo.price * ((100 - vo.sale) * 0.01)}"
                                                     pattern="#,###"/>원</p>
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <tr>
                        <th colspan="3">
                            <div class="d-flex justify-content-center">
                                <div>
                                    <button type="button" style="height:50px ;width:160px;"
                                            class="btn btn-sm btn-dark me-1">구매하기
                                    </button>
                                </div>
                                <div>
                                    <button type="button" onclick="addItemCart('${sessionScope.mid}')"
                                            style="height:50px;width:160px;"
                                            class="btn btn-sm btn-outline-secondary me-1">장바구니
                                    </button>
                                </div>
                                <div id="like-btn">
                                </div>
        ...
        <!----------------------------------상품상세보기 하단 메뉴 ---------------------------- -->
		  ...
		  <div style="border-bottom: 0.2px solid black; height: auto"></div>
		  <div id="tabs" style="width: 100%; height: auto">
				<ul >
					<li><a href="#tabs-1" style="width: 160px ;text-align: center">상품 상세 정보</a></li>
			        <li><a href="#tabs-2" style="width: 160px;text-align: center">상품 구매 안내</a></li> 
			        <li><a href="#tabs-3" style="width: 160px;text-align: center">상품 사용 후기</a></li> 
			        <li><a href="#tabs-4" style="width: 160px;text-align: center">상품 Q&A</a></li>
				</ul>
				<!------ 상품 상세정보 ------>
				<div id="tabs-1" >
					<div style="height:30px"></div>
		...
		<div id = "qna-list"></div>
			<div class="form-floating">
				<table class = "table">
				  <tr>
				    <td>
				      <span  class="btn btn-sm btn-danger" onclick="qnaInsert(${vo.ino })" style="float: right; color: white">문의</span>
				    </td>
				  </tr>
				</table>
				<div id="print">
