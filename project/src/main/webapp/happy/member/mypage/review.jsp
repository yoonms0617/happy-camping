            ...
            <div class="border-start border-end border-bottom p-0">
                <div class="p-3">
                    <div class="mx-3 mb-2">
                        ...
                        <div>
                            <a class="small text-primary text-underline-hover active" href="/mypage/review.do">리뷰 관리</a>
                        </div>
                        <div>
...
<script rel="script" src="/assets/project/member/js/mypage-review.js"></script>
</body>
</html>
